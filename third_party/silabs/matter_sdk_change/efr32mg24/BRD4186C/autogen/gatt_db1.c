...
GATT_DATA(const uint8_t gattdb_uuidtable_128_map[]) = {
    ...
    0xd0, 0x07, 0x9b, 0x5f, 0x80, 0x00, 0x01, 0x80, 0x01, 0x10, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00,
    0xd0, 0x07, 0x9b, 0x5f, 0x80, 0x00, 0x01, 0x80, 0x01, 0x10, 0x00, 0x00, 0x02, 0x01, 0x00, 0x00,
    0xd0, 0x07, 0x9b, 0x5f, 0x80, 0x00, 0x01, 0x80, 0x01, 0x10, 0x00, 0x00, 0x03, 0x01, 0x00, 0x00,
};
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_32) = { .len  = 2,
                                                                     .data = {
                                                                         0x50,
                                                                         0xfd,
                                                                     } };
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t
              gattdb_attribute_field_29)                         = { .properties = 0x02,
                                             .max_len    = 247,
                                             .len        = 15,
                                             .data       = {
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t
              gattdb_attribute_field_25)                         = { .properties = 0x02,
                                             .max_len    = 247,
                                             .len        = 15,
                                             .data       = {
                                                 0x01, 0x02, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
    ...
    { .handle      = 0x1c,
      ...
      .state       = 0x00,
      .datatype    = 0x02,
      .dynamicdata = &gattdb_attribute_field_25 },
    { .handle      = 0x1d,
      .uuid        = 0x0000,
      .permissions = 0x801,
      .caps        = 0xffff,
    ...
    { .handle      = 0x20,
      ...
      .state       = 0x00,
      .datatype    = 0x00,
      .constdata   = &gattdb_attribute_field_32 },
    { .handle         = 0x21,
      .uuid           = 0x0002,
      .permissions    = 0x801,
      .caps           = 0xffff,
      .state          = 0x00,
      .datatype       = 0x05,
      .characteristic = { .properties = 0x0a, .char_uuid = 0x8004 } },
    { .handle      = 0x22,
      .uuid        = 0x8004,
      .permissions = 0x803,
      .caps        = 0xffff,
    ...
    { .handle         = 0x23,
      ...
      .state          = 0x00,
      .datatype       = 0x05,
      .characteristic = { .properties = 0x3e, .char_uuid = 0x8005 } },
    { .handle      = 0x24,
      .uuid        = 0x8005,
      .permissions = 0x807,
      .caps        = 0xffff,
    ...
    { .handle         = 0x26,
      ...
      .state          = 0x00,
      .datatype       = 0x05,
      .characteristic = { .properties = 0x02, .char_uuid = 0x8006 } },
    { .handle      = 0x27,
      .uuid        = 0x8006,
      .permissions = 0x803,
      .caps        = 0xffff,
      .state       = 0x00,
      .datatype    = 0x02,
      .dynamicdata = &gattdb_attribute_field_29 },

};

GATT_HEADER( sli_bt_gattdb_t gattdb) = {
...
void matter_bluetooth_gatt_use_private_service(uint8_t is_private){
   if(is_private){
    //static_gattdb = &gattdb;
   }
   else{
    //static_gattdb = &gattdb_origin;
    gattdb.attribute_table_size = 31;
    gattdb.attribute_num = 31;
   }
}

void matter_bluetooth_gatt_characteristic_C3_change(uint8_t * value,uint8_t len){
   gattdb_attribute_field_25.len = len;
   memcpy(gattdb_attribute_field_25.data,value,len);
}

void matter_bluetooth_gatt_characteristic_T3_change(uint8_t * value,uint8_t len){
   gattdb_attribute_field_29.len = len;
   memcpy(gattdb_attribute_field_29.data,value,len);
}